...
// Package utils contains internal helper functions for go-dacc commands.
package utils
...
import (
	...
	"github.com/daccproject/go-dacc/common/fdlimit"
	...
	"github.com/daccproject/go-dacc/dashboard"
	...
	"github.com/daccproject/go-dacc/ethstats"
	"github.com/daccproject/go-dacc/les"
	"github.com/daccproject/go-dacc/log"
	"github.com/daccproject/go-dacc/metrics"
	"github.com/daccproject/go-dacc/metrics/influxdb"
	...
	"github.com/daccproject/go-dacc/p2p/nat"
	"github.com/daccproject/go-dacc/p2p/netutil"
	"github.com/daccproject/go-dacc/params"
	whisper "github.com/daccproject/go-dacc/whisper/whisperv6"
...
// for Gdacc and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gdacc account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gdacc.", map[string]string{
				"host": hosttag,
			})
		}
	}
...
// new format.
//
// e.g. gdacc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gdacc --keystore /tmp/mykeystore --lightkdf account new
//
