...
import (
	...
	bzzapi "github.com/daccproject/go-dacc/swarm/api"
	swarmmetrics "github.com/daccproject/go-dacc/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside gdacc.
func init() {
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-dacc Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gdacc only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gdacc and swarm
