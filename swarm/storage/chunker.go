...
import (
	...
	ch "github.com/daccproject/go-dacc/swarm/chunk"
	"github.com/daccproject/go-dacc/swarm/log"
	"github.com/daccproject/go-dacc/swarm/spancontext"
...
type JoinerParams struct {
	...
	addr   Address
	getter Getter
	// TODO: there is a bug, so depth can only be 0 today, see: https://github.com/ethersphere/go-dacc/issues/344
	depth int
	ctx   context.Context
}
