...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gdacc.ipc",
			endpoint:    "/data/testnet/gdacc.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gdacc.ipc",
			endpoint:    "/data/testnet/gdacc.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gdacc.ipc",
			endpoint:    "/data/testnet/gdacc.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gdacc.ipc",
			endpoint:    "/data/testnet/gdacc.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
...
// https://github.com/ethersphere/go-dacc/issues/639
