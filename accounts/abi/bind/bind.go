...
//
// Detailed usage document and tutorial available on the go-dacc Wiki page:
// https://github.com/daccproject/go-dacc/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/daccproject/go-dacc/accounts/abi"
