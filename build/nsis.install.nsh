Name "gdacc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/daccproject/go-dacc/issues"
!define UPDATEURL "https://github.com/daccproject/go-dacc/releases"
!define ABOUTURL "https://github.com/daccproject/go-dacc#ethereum-go"
...
# Install gdacc binary
Section "Gdacc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gdacc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdacc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdacc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gdacc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdacc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdacc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gdacc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gdacc.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gdacc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gdacc.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gdacc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gdacc.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/daccproject/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gdacc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gdacc.ipc"
