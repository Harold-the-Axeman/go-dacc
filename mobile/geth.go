...
// NodeConfig represents the collection of configuration values to fine tune the Gdacc
// node embedded into a mobile process. The available values are a subset of the
// entire API provided by go-dacc to reduce the maintenance surface and dev
// complexity.
...
// Node represents a Gdacc Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gdacc node.
