...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for go-dacc issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "gdacc-android-")
	if err != nil {
	...
	build.CopyFile(filepath.Join("libs", "gdacc.aar"), "gdacc.aar", os.ModePerm)
